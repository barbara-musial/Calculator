...
b1.grid(column=0, row=3, sticky='NSEW')
...
plus = tk.Button(win, text='+', bg='#66ccff', activeforeground='#cccccc', bd=4,
                 command=add)
plus.grid(column=3, row=3, rowspan=2, sticky='NSEW')
